                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <h5 class="fw-bolder">Jhovensent Angradean</h5>
                                        </div>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                        <h5 class="fw-bolder">Ferdi Purnama</h5>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                        <h5 class="fw-bolder">Michael Wijaya</h5>
                                        </div>
                                    </div>
                                </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                        <h5 class="fw-bolder">Maria Carol Stephanie Lirungan</h5>
