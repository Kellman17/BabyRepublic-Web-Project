<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if (!count($data)) {
            echo "<script>alert('data tidak ditemukan');window.location='banner.php';</script>";
        }


    }else{
        echo "<script>alert('Masukkan ID yang ingin di Edit');window.location='banner.php';</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form method="POST" action="proseseditbanner.php" enctype="multipart/form-data">
                    <section class="base">
                    <center><h1>EDIT BANNER <?php echo $data ['keterangan']; ?></h1></center>
                    <div>
