<?php
    ...
    if (isset($_GET['id'])) {
        ...
        echo "<script>alert('Masukkan ID yang ingin di Edit');window.location='product.php';</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form method="POST" action="proseseditproduct.php" enctype="multipart/form-data">
                    <section class="base">
                    <center><h1>EDIT PRODUCT <?php echo $data ['name']; ?></h1></center>
                    <div>
                        <label>Name :</label>
