<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if (!count($data)) {
            echo "<script>alert('data tidak ditemukan');window.location='slideshow.php';</script>";
        }


    }else{
        echo "<script>alert('Masukkan ID yang ingin di Edit');window.location='slideshow.php';</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form method="POST" action="proseseditss.php" enctype="multipart/form-data">
                    <section class="base">
                    <center><h1>EDIT SLIDE SHOW <?php echo $data ['keterangan']; ?></h1></center>
                    <div>
                        <label>Keterangan : <?php echo $data ['keterangan']; ?></label>
                        <input type="hidden" name="keterangan" required="" VALUE="<?php echo $data ['keterangan']; ?>">
                        <input type="hidden" name="id" required="" VALUE="<?php echo $data ['id']; ?>">
                    </div>
                    <div>
                        <label>Image URL :</label>
                        <input type="url" name="image" required="" VALUE="<?php echo $data ['image']; ?>">
                    </div>
                    <div>
