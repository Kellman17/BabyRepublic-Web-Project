...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($koneksi,  "INSERT INTO porder (name,email,number,address,city,method,pin,total) 
   VALUES ('$name','$email','$number','$address1','$city','$method','$pin','$total')") or die('query failed');
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='order-detail'>
            ...
            <span class='total'> total : Rp".$total."/-  </span>
         </div>
         <div class='customer-details'>
            <p> your name : <span>".$name."</span> </p>
            <p> your number : <span>".$number."</span> </p>
            <p> your email : <span>".$email."</span> </p>
            <p> your address : <span>".$address1.", ".$city." - ".$pin."</span> </p>
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Alamat</span>
            <input type="text" placeholder="Jl. a" name="address" required>
         </div>
         <div class="inputBox">
            <span>Kota</span>
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="12345" name="pin" required>
         </div>
      </div>
