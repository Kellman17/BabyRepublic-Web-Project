...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($koneksi, "INSERT INTO `checkout`(name, number, email, method, street, city,pin_code, total_products )
   VALUES('$name','$number','$email','$method','$street','$city','$pin_code','$total_products')") or die('query failed');
