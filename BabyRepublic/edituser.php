<?php
    ...
    if (isset($_GET['id'])) {
        ...
        echo "<script>alert('Masukkan ID yang ingin di Edit');window.location='user.php';</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <section class="base">
                    <center><h1>EDIT USER <?php echo $data ['name']; ?></h1></center>
                    <div>
                        <label>Name :</label>
                    ...
                    <div>
                        <label>Role :</label>
                        <input type="text" name="role" required="" VALUE="<?php echo $data ['role']; ?>">
                    </div>
                    <div>
